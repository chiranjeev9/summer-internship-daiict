                  ...
                  <!-- <div class="form-group" style="display:">
                    ...
                    <select class="form-control" id="selectsubcategory">
                          ...
                          <?php
                            ...
                            while($row1=mysqli_fetch_array($conres))
                            {
                              echo '<option>'.$row1["subcategoryname"].'</option>';
                            }
                   ...
                   <div class="form-group" style="display:">
                    <label>GST</label>
                    <input type="hidden" class="form-control" id="gstid">
                    <input type="text" class="form-control" id="gst" placeholder="Enter GST ">
                  </div>
                  <div class="form-group" style="display:">
                    <label>Product Unit</label>
                    <input type="hidden" class="form-control" id="productunit">
                    <input type="Number" class="form-control" id="productunit" placeholder="Enter productunit ">
                  </div>
                </div>
                <!-- /.card-body -->
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" id="Data">
                <table class="table table-hover table-bordered" id="City-table">
                  <thead>
                    <tr>
                      <th>Price ID</th>
                      <th>Price Name</th>
