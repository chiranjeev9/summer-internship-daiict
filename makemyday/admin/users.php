<?php
    ...
    $userres=mysqli_query($Create_Connection,"Select * from userm,countrym,statem,citym where citym.cityid=userm.cityid and statem.stateid=citym.stateid and countrym.countryid=statem.countryid");
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group" style="display:">
                      ...
                      <input type="text" class="form-control" name="alternatecontactno" placeholder="Enter Contact no"> 
                    </div>
                    </div>
                    <div class="col-md-4">
                    <div class="form-group" style="display:">
                    ...
                    <div class="form-group" style="display:">
                      ...
                      <input type="text" class="form-control" name="addressline1" placeholder="Enter Addressline1">
                    </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="form-group" style="display:">
                      ...
                      <input type="text" class="form-control" name="addressline2" placeholder="Enter Addressline 2"> 
                    </div>
                    </div>
                    <div class="col-md-4">
                    <div class="form-group" style="display:">
              ...
              <!-- <div class="card-body table-responsive p-0" id="Data" style="display: block;">
                <table class="table table-hover table-bordered" id="User_Data_Table">
                  <tbody>
                    <?php
                      while($urow=mysqli_fetch_array($ures))
                      {
                        echo '
                              <tr>
                                ...
                                <td>'.$urow["middlename"].'</td>
                                <td>'.$urow["lastname"].'</td>
                                <td>'.$urow["gender"].'</td>
                                <td>'.$urow["dateofbirth"].'</td>
                                <td>'.$urow["contactno"].'</td>
                                <td>'.$urow["alternateno"].'</td>
                                <td>'.$urow["emailid"].'</td>
                                <td>'.$urow["addressline1"].'</td>
                                <td>'.$urow["addressline2"].'</td>
                                <td>'.$urow["road"].'</td>
                                <td>'.$urow["landmark"].'</td>
                                <td>'.$urow["countryname"].'</td>
                                <td>'.$urow["statename"].'</td>
                                <td>'.$urow["cityname"].'</td>
                                <td>'.$urow["pincode"].'</td>
                                <td>'.md5($urow["password"]).'</td>
                                <td>'.$urow["usertype"].'</td>
                                <td>'.$urow["userphoto"].'</td>
                                <td>'.$urow["isactive"].'</td>
                              </tr>
                        ';
                      }  
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" id="Data">
                <table class="table table-hover table-bordered" id="User-table">
                  ...
                  <tbody>
                    <?php
                      while($urow=mysqli_fetch_array($userres))
                      {
                        echo '
                              <tr>
                                <td>'.$urow["userid"].'</td>
