              ...
              <form role="form">
                <div class="card-body">
                  <div class="form-group" style="display:">
                    ...
                    <input type="number" class="form-control" id="Statename" placeholder="Enter Quantity">
                  </div>
                  <div class="form-group" style="display:">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" id="Data">
                <table class="table table-hover table-bordered" id="State-table">
                  <thead>
                    <tr>
                      <th>Product ID</th>
                      <th>Product Name</th>
...
<script>
                ...
                for(var i = 1; i < table.rows.length; i++)
                {
                    table.rows[i].onclick = function()
                    {
                         ...
                         document.getElementById("Stateid").value = this.cells[0].innerHTML;
                         document.getElementById("Statename").value = this.cells[1].innerHTML;
                         document.getElementById("selectcountry").value = this.cells[2].innerHTML;
                         window.scrollTo(0, 0);
                    };
                }
</script>
