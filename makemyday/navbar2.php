<?php
	...
	else
	{
		...
		$account='<li class="nav-item cta cta-colored"><a href="#" class="nav-link"><span class="icon-shopping_cart"></span>My Orders</a></li>';
		$link="logout.php";
	}*/
...
<div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="cart.php" class="nav-link">Cart</a></li>
	          ...
	          <?php
	          if(isset($uid)){
	           echo '<li class="nav-item cta cta-colored"><a href="wishlist.php" class="nav-link"><span class="icon-shopping_cart"></span>My Wishlist</a></li>';
	           echo '<li class="nav-item cta cta-colored"><a href="order.php" class="nav-link"><span class="icon-shopping_cart"></span>My Orders</a></li>';
	           echo '<li class="nav-item cta cta-colored"><a href="order.php" class="nav-link"><span class="icon-shopping_cart"></span>My Orders</a></li>'; 
	       		}
	       		?>
